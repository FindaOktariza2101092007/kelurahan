    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item"><a>Persyaratan</a></div>
            </div>
        </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>Surat Pengantar RT/RW
                            ...
                            <hr>Sewa Penyewa/Surat Kavling/Bukti Kepemilikan Tempat
                        </td>
                        <td class="text-center">
...
@include('pages.admin.persyaratan.create')
@include('pages.admin.persyaratan.edit')
