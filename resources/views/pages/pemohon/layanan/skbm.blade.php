...
@section('title')
<h6>Surat Keterangan Belum Menikah</h6>
@endsection
...
@section('content')
            ...
            <table id="example" class="table table-striped table-bordered mt-1 table-sm" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr style="background-color: #FCFFE7">
                        ...
                        <td class="text-center">Surat Keterangan Belum Menikah</td>
            ...
            <table id="example" class="table table-striped table-bordered mt-1 table-sm" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr style="background-color: #FCFFE7">
                        ...
                        <td class="text-center">Surat Keterangan Belum Menikah</td>
                        <td class="text-center">Budi Setiawan</td>
                        <td class="text-center"> <button class="btn btn-danger" data-toggle="modal" data-target="#exampleModal">Ditolak</td>
                    </tr>
            ...
            <table id="example" class="table table-striped table-bordered mt-1 table-sm" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr style="background-color: #FCFFE7">
                        ...
                        <td class="text-center">Surat Keterangan Belum Menikah</td>
                        <td class="text-center">Budi Setiawan</td>
                        <td class="text-center"> <button class="btn btn-success" data-toggle="modal" data-target="#selesaiModal">Selesai</td>
                    </tr>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        ...
                        <span aria-hidden="true">&times;</span>
                            ...
                            <h5 class="modal-title" id="exampleModalLabel"  ><i class="fas fa-exclamation-circle " style="font-size: 40px; color:orange; "></i></h5>
                            <br>
                            ...
                            <div class="modal-footer justify-content-center">
                                ...
                                <button type="button" class="btn btn-primary" class="btn btn-center" data-dismiss="modal">Kembali</button>
                            </div>
                            </div>
                        </div>
                        </div>
                        ...
                        <span aria-hidden="true">&times;</span>
                            ...
                            <br>
                                ...
                                <h5 class="modal-title" id="selesaiModalLabel"  > <img src="images/surat.png" alt="surat" style="width:150px; height:auto; margin-right:10px;" ></h5>

                            <div class="modal-footer justify-content-center">
                                <button type="button" class="btn btn-primary" class="btn btn-center" data-dismiss="modal">Unduh Surat Keterangan Belum Menikah</button>
                            </div>
                            </div>
                            </div>
                        </div>
