    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="/monitoring"><span
                            style="font-weight: bold;">monitoring</a></span></div>
                ...
                <tbody>
                    ...
                    <tr style="background-color: #FCFFE7">
                        ...
                        <td class="text-center"> <button class="btn btn-danger" data-toggle="modal"
                                data-target="#exampleModal">Ditolak</td>
                    </tr>
                </tbody>
            </table>
                ...
                <div class="modal-body text-center">
                    ...
                    <div class="modal-footer justify-content-center">
                        <button type="button" class="btn btn-primary" class="btn btn-center" data-dismiss="modal">Unduh
                            Surat Keterangan Domisili</button>
                    </div>
                </div>
            </div>
        </div>
