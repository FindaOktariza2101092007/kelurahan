		            ...
		            <div class="wizard-container">
		                ...
		                <!--        You can switch " data-color="orange" "  with one of the next bright colors: "blue", "green", "orange", "red", "azure"          -->
		                    	...
		                    	<div class="wizard-header text-center">
		                        	<h3 class="wizard-title">Form Permohonan Surat Keterangan Kematian</h3>
									<p class="category">Lengkapi Data</p>
		                    	</div>
		                        ...
		                        <div class="tab-content">
		                            ...
		                            <div class="tab-pane" id="address">
		                                <div class="row">
                                        <div class="col-sm-12">
		                                        <h5 class="info-text"> Data Diri yang Meninggal </h5>
		                                    </div>
                                        <div class="col-md-6">
		                                    	<div class="form-group">
		                                            <label>NIK</label>
                                            ...
                                            <div class="form-group">
                                                    <label for="pekerjaan">Pekerjaan</label>
                                                    <select class="form-control" id="pekerjaan"size="1">
                                            ...
                                            <div class="form-group">
                                                <label for="agama">Agama</label>
                                                <select class="form-control" id="agama"size="1">
                                            ...
                                            <div class="col-md-6">
		                                        <div class="form-group">
		                                            ...
		                                            <input type="text" class="form-control" placeholder="Bin / Binti">
		                                        </div>
		                                    </div>
                                            <div class="col-md-6">
		                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="tempat_meninggal" placeholder="Tempat Meninggal">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                             <div class="form-group">
                                                <label for="status_nikah">Status Pernikahan</label>
                                                <select class="form-control" id="status_nikah" size="1">
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="sebab" placeholder="Sebab Kematian">
                                                </div>
                                            </div>
