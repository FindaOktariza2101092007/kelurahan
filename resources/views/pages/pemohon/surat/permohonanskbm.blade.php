                            ...
                            <div class="card wizard-card" data-color="blue" id="wizardProfile">
                                <form action="" method="">
                                    ...
                                    <div class="wizard-header text-center">
                                        <h3 class="wizard-title">Form Permohonan Surat Keterangan Belum Menikah</h3>
                                        <p class="category">Lengkapi Form</p>
                                    </div>
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane" id="address">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <label for="formFile" class="form-label">Upload Surat Keterangan
                                                        RT/RW</label>
                                                    <input class="form-control" type="file" id="formFile">
                                                </div>
                                    ...
                                    <div class="wizard-footer">
                                        <div class="pull-right">
                                            ...
                                            <input type='button' class='btn btn-finish btn-fill btn-primary btn-wd'
                                                data-toggle="modal" data-target="#exampleModal" name='ajukan'
