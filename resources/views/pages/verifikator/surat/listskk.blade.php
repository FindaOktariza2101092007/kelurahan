...
@section('title')
    List Permohonan Surat Keterangan Kematian
@endsection
    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="/listskk">Surat Keterangan Kematian</a></div>
            </div>
        </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="/detailskk" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i></span> Detail</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>2</td>
