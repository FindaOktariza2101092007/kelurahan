...
@section('title')
    Detail Permohonan Surat Keterangan Kematian
@endsection
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-center">
                <a href="/listskk" class="btn btn-primary">Simpan</a>
            </div>
        </div>
    </div>
</div>
    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="/detailskk">Budi Setiawan</a></div>
            </div>
        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="status_nikah" placeholder="Menikah">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <form action="/submit-form" method="POST">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <label for="nama">Nama Lengkap</label>
                                            <input type="text" class="form-control" id="nama" placeholder="Bapaknya Budi">
                                        </div>
                                        <div class="form-group">
                                            <label for="bin">Bin/Binti</label>
                                            <input type="text" class="form-control" id="bin" placeholder="Saleh">
                                        </div>
                                        <div class="form-group">
                                            <label for="tempat_lahir">Tempat Lahir</label>
                                            <input type="text" class="form-control" id="tempat_lahir" placeholder="Padang">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="email">Status Pernikahan</label>
                                            <input type="status" class="form-control" id="email" placeholder="Menikah">
                                        </div>
                                        <div class="form-group">
                                            <label for="agama">Agama</label>
                                            <input type="text" class="form-control" id="agama" placeholder="Islam">
                                        ...
                                        <div class="form-group">
                                            <label for="status_nikah">Jam Meninggal</label>
                                            <input type="text" class="form-control" id="status_nikah" placeholder="10.30">
                                        </div>
                                        <div class="form-group">
                                            <label for="status_nikah">Tanggal Meninggal</label>
                                            <input type="text" class="form-control" id="status_nikah" placeholder="10/10/2010">
                                        </div>
                                        <div class="form-group">
                                            <label for="status_nikah">Tempat Meninggal</label>
                                            <input type="text" class="form-control" id="status_nikah" placeholder="Rs Ibnu Sina">
                                        </div>
                                        <div class="form-group">
                                            <label for="status_nikah">Sebab Meninggal</label>
                                            <input type="text" class="form-control" id="status_nikah" placeholder="Serangan Jantung">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="req_surat" placeholder="Surat Keterangan Kematian">
                                    </div>
                                    {{-- <div class="form-group">
                                        <label for="bid_usaha">Bidang Usaha</label>
                                        <input type="text" class="form-control" id="bid_usaha" placeholder="Perdagangan">
                                    </div> --}}
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
