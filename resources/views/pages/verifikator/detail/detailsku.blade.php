...
@section('title')
    Detail Permohonan Surat Keterangan Usaha
@endsection
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-center">
                <a href="/listsku" class="btn btn-primary">Simpan</a>
            </div>
        </div>
    </div>
</div>
    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="/detailsku">Budi Setiawan</a></div>
            </div>
        </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="req_surat" placeholder="Surat Keterangan Usaha">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="keperluan_usaha">Keperluan Usaha</label>
                                        <input type="text" class="form-control" id="keperluan_usaha" placeholder="Perdagangan">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
