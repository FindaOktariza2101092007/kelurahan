                ...
                <div class="card-body">
                    <form>
                        <div class="d-flex bd-highlight mb-3 align-items-center">
                            ...
                            <div class="p-2 bd-highlight">
                                <select class="js-example-basic-single py-0  name="surat_id" style="width: 100%">
                                    <option disabled selected value=""> Pilih Status Permohonan</option>
            ...
            <table id="example" class="table table-striped table-bordered mt-1 table-sm" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr style="background-color: #FCFFE7">
                        ...
                        <td class="text-center">Surat Keterangan Domisili</td>
                        <td class="text-center">Finda Oktariza</td>
                        <td class="text-center">
                            <button class="btn btn-success" class="btn btn-icon btn-primary btn-sm mr-2" type="button"
                                data-toggle="modal" data-target="#selesaiModal">Selesai
                            </button>
                        </td>
                    </tr>
                </tbody>
                <tbody>
                    <tr style="background-color: #FFFFFF">
                        ...
                        <td class="text-center">Dea Insani</td>
                ...
                <tbody>
                    <tr style="background-color: #FCFFE7">
                        ...
                        <td class="text-center">Khozi Natul Amroor</td>
                        <td class="text-center"> <button class="btn btn-danger" data-toggle="modal"
                                data-target="#ditolakModal">Ditolak</td>
                    </tr>
                </tbody>
            </table>
